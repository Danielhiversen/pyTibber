...
async def test_tibber_get_historic_data():
    async with aiohttp.ClientSession() as session:
        ...
        assert historic_data[0]["from"] == "2024-01-01T00:00:00+01:00", "First day must be 2024-01-01"
        assert historic_data[4]["from"] == "2024-01-05T00:00:00+01:00", "Last day must be 2024-01-05"
